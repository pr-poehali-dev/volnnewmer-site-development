...
const Benefits = () => {
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Первые изменения заметны уже после 2-3 процедур. Накопительный эффект до 12 месяцев",
    },
    {
      icon: "Clock",
        ...
        <div className="mt-8 bg-white p-8 rounded-2xl shadow-sm">
          <div className="text-center">
            ...
            <p className="text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              Результаты могут индивидуально варьироваться. Мы предоставляем
              косметологические услуги, а не продаем медицинское оборудование.
            </p>
          </div>
        </div>
      </div>
